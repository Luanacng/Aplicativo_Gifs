...
class Esportes extends StatefulWidget {
  @override
  _EsportesState createState() => _EsportesState();
}

class _EsportesState extends State<Esportes> {
  String _search;
  int _offset = 0;
  ...
  Future<Map> _getGifs() async {
    ...
    if (_search == null)
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=IIMOmq29wlzyTjBo4Tnv4ylTuNn6xoKS&q=sports&limit=25&offset=25&rating=g&lang=en");
